...
!!! danger "Wichtiger Hinweis!"
    ...
    **Die Nutzung der hier aufgeführten Informationen erfolgt auf eigenes Risiko. Wir übernehmen keine Haftung für direkte oder indirekte Schäden, die aus der Anwendung der bereitgestellten Einstellungen entstehen könnten.**

### 5x JK-InverterBMS 200A (16S); 2x Victron Multiplus 5000

#### BSC - Einstellungen Serielle Schnittstelle

![Einstellungen Serielle Schnittstelle](img/beispielconfig/beispielcfg_serial.png){ width="450" }
...
![Einstellungen Inverter](img/beispielconfig/beispielcfg_inverter_general_1.png){ width="450" }

![Einstellungen Batterietemperatur](img/beispielconfig/beispielcfg_inverter_general_2.png){ width="450" }

##### Laden

![Ladestrom drosseln](img/beispielconfig/beispielcfg_inverter_charge_1.png){ width="450" }
![Autobalance](img/beispielconfig/beispielcfg_inverter_charge_2.png){ width="450" }

##### Entladen

![Entladestrom drosseln](img/beispielconfig/beispielcfg_inverter_discharge_1.png){ width="450" }

#### BMS

##### Settings

![Beispiel BMS Settings](img/beispielconfig/beispielcfg_bms_settings_jk_1.png){ width="350" }
![Beispiel BMS Settings](img/beispielconfig/beispielcfg_bms_settings_jk_2.png){ width="350" }
![Beispiel BMS Settings](img/beispielconfig/beispielcfg_bms_settings_jk_3.png){ width="350" }
![Beispiel BMS Settings](img/beispielconfig/beispielcfg_bms_settings_jk_4.png){ width="350" }

##### Control

![Beispiel BMS Control](img/beispielconfig/beispielcfg_bms_settings_jk_5.png){ width="350" }
...
![Einstellungen Inverter Allgemein](img/beispielconfig/beispielcfg_inverter_general_seplos.png){ width="1050" }

##### Laden

![Einstellungen Inverter Laden](img/beispielconfig/beispielcfg_inverter_charge_seplos.png){ width="1050" }

##### Entladen

![Einstellungen Inverter Entladen](img/beispielconfig/beispielcfg_inverter_discharge_seplos.png){ width="350" }

#### BMS

##### Parameter

![Beispiel BMS Parameter](img/beispielconfig/beispielcfg_bms_seplos_parameter.png){ width="1050" }

##### Switches

![Beispiel BMS Switches](img/beispielconfig/beispielcfg_bms_switches.png){ width="1050" }
