...
Es gibt zwei Möglichkeiten die vTrigger "speichernd" über einen Neustart hinaus zu erhalten:  
...
![MQTT Dateien](img/mqtt/mqtt_files.png)
...
Der DataDeviceName muss von Ihnen, je nach BSC-Konfiguration, korrekt in den Dateien benannt werden.  
...
* Rechtsklick -> "Change all Occurrences"  
  ![VSCode: Change all Occurrences](img/mqtt/mqtt_uuid_generator.jpg)
* Rechtsklick -> "Generate UUID at Cursor"  
  ![VSCode: Generate UUID at Cursor](img/mqtt/mqtt_uuid_generator_2.jpg)
  ![VSCode: Generate UUID at Cursor](img/mqtt/mqtt_uuid_generator_3.jpg)  
* Speichern
