...
![NEEY Statusmeldungen](../img/devices/devices_neey_status.png){  width="520" }
...
![Seplos Konfiguration Single Pack](../img/devices/devices_seplos_config_single.png)

![Seplos Konfiguration Multi Pack](../img/devices/devices_seplos_config_multi.png)
...
- Die Adressierung 1 aufwärts (ohne lücken) über die DIP-Schalter einstellen. Hierbei beachten, dass 0000 = Adresse 1, 0001 = Adresse 2 ist!
...
![Datenquelle konfigurieren](../img/settings/settings_inverter_datquelle.png){  width="550" }
...
![Pace PC200 Einzel-Pack-Konfiguration](../img/devices/devices_Pace_PC200-Singlepack.png)
...
![Pace PC200 Multi-Pack-Konfiguration](../img/devices/devices_Pace_PC200-Multipack.png)
