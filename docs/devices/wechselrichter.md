...
![CAN Bus BMS](../img/devices/devices_inverter_venus_canbus.png)  

Network status wenn alles klappt  
![CANbus](../img/devices/devices_inverter_venus_canbus2.png)  

Alles wird erkannt  
![Everything detected](../img/devices/devices_inverter_venus_canbus_devicelist.png)

### BSC Log-Ausgabe wenn Inverter erkannt wurde

![CAN Log](../img/devices/devices_inverter_can_log.png)
...
![Deye SUN-12K-SG04LP3-EU](../img/devices/devices_inverter_deye_sun_12k_sg04lp3-eu.png){ width="450" }
