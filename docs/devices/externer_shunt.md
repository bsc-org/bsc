...
![Victron Smartshunt Stecker](../img/devices/devices_shunt_smartshunt_vedirect_stecker.png){  width="550" }
...
![RS485 Converter](../img/devices/devices_shunt_smartshunt_rs485_converter.png){  width="300" }
...
![BMS für SoC Einstellen](../img/devices/devices_shunt_smartshunt_bsc_settings.png){  width="400" }

Einstellungen sind wie folgt zu finden:
