...
Falls die originale BSC-Hardware nicht verfügbar ist, ist die Empfehlung als Alternative das T-CONNECT von Lilygo einzusetzen. Auch hier sind die RS485 Anschlüsse und der CANBUS galvanisch getrennt. Bitte beachten Sie, dass in diesem Fall bestimmte Funktionen eingeschränkt sind.  
...
Für erste Tests kann alternativ ein ESP32-Dev-Kit verwenden. Beachten Sie jedoch, dass einige Funktionen eingeschränkt oder nicht getestet sind. Weitere Informationen finden Sie unter ["BSC ohne originale Hardware"](BSC_ohne_orig_hardware.md).
...
![Hardware Stecker 9 Polig](img/hardware/hw_stecker_9pol.png){ width="300" }
![Hardware Stecker 6 Polig](img/hardware/hw_stecker_6pol.png){ width="300" }
...
* U19 ist für eine **höhere Versorgungsspannung** größer 5V mit einem DC-DC Wandler zu bestücken
    ...
    * Zur redundanten Spannungsversorgung, oder Spannungen über dem genannten Wert, werden getrennte 5V Netzteile im <a href="https://bsc-shop.com" target="_blank">BSC-Shop</a> angeboten.
...
![HW Bestückung U19](img/hardware/hw_bestueckung_u19.jpg){ width="400" }
...
![HW Trennen Lötjumper](img/hardware/hw_trennen_loetjumper.jpg){ width="600" }
...
![HW Jumper J6](img/hardware/hw_jumper_j6.png){ width="400" }
...
![HW Jumper J4](img/hardware/hw_jumper_j4.png){ width="400" }
...
![HW Relais Vin](img/hardware/hw_relais_vin.png){ width="600" }
...
![HW Relais Jumper J14 J16](img/hardware/hw_relais_jumper_j14_j16.png){ width="600" }
...
### Unterstütztes Display

Hardware-Version 3.3 des Displays wurde getestet.  
Erhältlich beispielsweise über Aliexpress von verschiedenen Versendern.  
![HW Display](img/hardware/hw_display.png){ width="500" }
...
![HW Display Stecker J3](img/hardware/hw_display_stecker_j3.png){ width="400" }
![HW Display Stecker J3](img/hardware/hw_display_stecker_j3_2.png){ width="200" }

### Pinout des Displays "WT32-SC01"

![WT32-SC01 Pinout](img/hardware/hw_pinout_display_wt32sc01.png){ width="700" }
