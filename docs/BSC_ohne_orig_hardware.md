...
!!! danger "Wichtiger Hinweis!"
    ...
    Die original [Hardware](hardware.md) ist erprobt, dafür ausgelegt und vor allem galvanisch getrennt, was gerade bei negativ schaltenden BMS-Typen ein sehr wichtiger Aspekt ist.
...
![RS485 Konverter](img/bsc_ohne_org_hw_rs485_converter.jpg){ width="450" }
...
![CAN Converter](img/bsc_ohne_org_hw_can_converter.jpg){ width="450" }
